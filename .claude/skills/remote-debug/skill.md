...
3. **Auth token**: `cargorunmediar123` (Packer image default)
...
export MCP_AUTH_TOKEN="cargorunmediar123"
...
### "401 Unauthorized"
- Check `MCP_AUTH_TOKEN` is set correctly (`export MCP_AUTH_TOKEN="cargorunmediar123"`)
