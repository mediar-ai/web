...
-- Seed ExampleClient historical months (Oct 2025 - Apr 2026).
-- Pre-May months are estimated for Oct-Dec/early-Jan; actuals for the rest.
-- See apps/web/src/data/billing-snapshots/ExampleClient.json for source of truth.
INSERT INTO billing_snapshots (organization_id, month_key, data, frozen_at) VALUES
('org_REDACTED', '2025-10', '{
