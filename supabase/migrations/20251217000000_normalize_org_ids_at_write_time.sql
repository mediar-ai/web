...
-- Migrate existing Stoke workflows from dev to prod org ID (if any)
UPDATE deployed_workflows
SET organization_id = 'org_2yyo35c5YVUqjJ86qen45VfwwxD'
WHERE organization_id = 'org_2yycYh2ig5m8LwgONhJfZGYhkm9';
