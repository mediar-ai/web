...
if __name__ == "__main__":
    ...
    os.system('psql "postgresql://postgres.eshwntsgsputksqamckh:***REMOVED***@aws-0-us-west-1.pooler.supabase.com:5432/postgres" -c "SELECT raw_mcp_response FROM workflow_executions WHERE id = 263;" -t -A > temp_mcp_response.json 2>/dev/null')
