...
import { stopVm, isAzureConfigured, createAuditContext, initTelemetry } from '@mediar/infra';
...
export async function POST(
  ...
  try {
    ...
    // Stop the VM
    const result = await stopVm(machine.azure_resource_id, createAuditContext(userId, 'api'));
