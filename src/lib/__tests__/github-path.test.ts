 ...
 * - Legacy snake_case: "onedrive_install_typescript", "imperial_treasure_1_typescript"
 *
...
describe('GitHub path parsing', () => {
  ...
  describe('Legacy snake_case format', () => {
    ...
    it('should handle legacy numbered folder', () => {
      const result = getTerminatorPath('imperial_treasure_1_typescript');
      expect(result).toBe('imperial_treasure_1_typescript/src/terminator.ts');
    });
  });
