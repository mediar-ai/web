        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mb-2">
              {/* Test Run - shows automated status for workflows with cron */}
              {workflow.cron_expression ? (
                workflow.cron_enabled ? (
                  ...
                  <div className="flex items-center gap-2 px-6 py-2.5 bg-red-100 border-2 border-red-600 rounded-lg font-mono text-base font-bold text-red-800">
                    <AlertCircle className="w-5 h-5" />
                    AUTO-PAUSED
                  </div>
                ) : (
                  <div className="flex items-center gap-2 px-6 py-2.5 bg-white border-2 border-gray-400 rounded-lg font-mono text-base text-gray-600">
                    <Clock className="w-5 h-5" />
                    AUTOMATED (PAUSED)
                  </div>
                )
