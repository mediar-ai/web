...
def get_db_connection():
    ...
    conn_string = os.getenv('SUPABASE_CONN_STRING') or 'postgresql://postgres.eshwntsgsputksqamckh:dS64xX6mU3E4Sbyc@aws-0-us-west-1.pooler.supabase.com:5432/postgres'
    try:
