...
organization_id: org_2yydAO45WOB4RaCE4F4BNUPtw9c  ← NOT NULL!
is_shared: True
...
- ❌ `organization_id IS NULL` - Workflow 57 DOES NOT have this (it's `org_2yydAO45WOB4RaCE4F4BNUPtw9c`)
...
```
Org: org_2yynzGa53bNM1GTPLp5mc2lYRyD (Mediar main)
  Owned: 5 workflows
  Shared: 10 workflows
  Public: 0 workflows  ← NO PUBLIC WORKFLOWS
  Total: 15 workflows

Org: org_2yydAO45WOB4RaCE4F4BNUPtw9c (Mediar legacy - owns workflow 57)
  Owned: 12 workflows (includes workflow 57)
  Shared: 15 workflows
  Public: 0 workflows  ← NO PUBLIC WORKFLOWS
  Total: 27 workflows

Org: org_357s7Sx2p5rtzmPrxQCFGOPW9OK (other user)
  Owned: 9 workflows
  Shared: 9 workflows
  Public: 0 workflows  ← NO PUBLIC WORKFLOWS
  Total: 18 workflows
...
1. **Users from org `org_2yydAO45WOB4RaCE4F4BNUPtw9c`**: ✅ Can see it (they own it)
...
**Before**:
```
organization_id: org_2yydAO45WOB4RaCE4F4BNUPtw9c
is_shared: True
```

**After**:
```
organization_id: org_2yydAO45WOB4RaCE4F4BNUPtw9c (unchanged - already has org)
...
- Workflow 57 is only visible to `org_2yydAO45WOB4RaCE4F4BNUPtw9c` members
...
2. **Check workflow 57 purpose**:
   ...
   Owner: org_2yydAO45WOB4RaCE4F4BNUPtw9c (Mediar legacy)
   ```
...
- User from `org_2yynzGa53bNM1GTPLp5mc2lYRyD`: ✅ Sees workflow 57
- User from `org_357s7Sx2p5rtzmPrxQCFGOPW9OK`: ✅ Sees workflow 57
