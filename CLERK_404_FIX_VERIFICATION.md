...
[mediarAuth] Using org from desktop token: org_REDACTED for user: matt@mediar.ai
...
✅ Created workflow with ID: 126
✅ Saved to GitHub: org-org_REDACTED/newrecording/workflow.yaml  ✅
```
...
// validation.userId = "user_REDACTED" ✅
...
Expected: `clerk_user_id` should be populated with values like `user_REDACTED`
