...
describe("Gesture handler", function () {
  ...
  function touchStart(id, x, y) {
    let touch = { identifier: id, clientX: x, clientY: y };
    touches.push(touch);
    let ev = {
      type: "touchstart",
      touches: touches,
  ...
  describe("Single finger tap", function () {
    it("should handle single finger tap", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "onetap", clientX: 20.0, clientY: 30.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gestureend", detail: { type: "onetap", clientX: 20.0, clientY: 30.0 } })
      );
    });
  });
  ...
  describe("Two finger tap", function () {
    it("should handle two finger tap", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "twotap", clientX: 25.0, clientY: 40.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gestureend", detail: { type: "twotap", clientX: 25.0, clientY: 40.0 } })
      );
    });
  ...
  describe("Three finger tap", function () {
    it("should handle three finger tap", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "threetap", clientX: 30.0, clientY: 40.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gestureend", detail: { type: "threetap", clientX: 30.0, clientY: 40.0 } })
      );
    });
  ...
  describe("Single finger drag", function () {
    it("should handle horizontal single finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "drag", clientX: 20.0, clientY: 30.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gesturemove", detail: { type: "drag", clientX: 80.0, clientY: 30.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "drag", clientX: 80.0, clientY: 30.0 } })
      );
    });
    ...
    it("should handle vertical single finger drag", function () {
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gesturemove", detail: { type: "drag", clientX: 20.0, clientY: 90.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "drag", clientX: 20.0, clientY: 90.0 } })
      );
    });
    ...
    it("should handle diagonal single finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "drag", clientX: 120.0, clientY: 130.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gesturemove", detail: { type: "drag", clientX: 60.0, clientY: 70.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "drag", clientX: 60.0, clientY: 70.0 } })
      );
    });
  });
  ...
  describe("Long press", function () {
    it("should handle long press", function () {
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gesturestart", detail: { type: "longpress", clientX: 20.0, clientY: 30.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "longpress", clientX: 20.0, clientY: 30.0 } })
      );
    });
    ...
    it("should handle long press drag", function () {
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gesturemove", detail: { type: "longpress", clientX: 120.0, clientY: 50.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "longpress", clientX: 120.0, clientY: 50.0 } })
      );
    });
  });
  ...
  describe("Two finger drag", function () {
    it("should handle fast and distinct horizontal two finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "twodrag", clientX: 25.0, clientY: 30.0, magnitudeX: 0.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 25.0, clientY: 30.0, magnitudeX: 60.0, magnitudeY: 0.0 },
        })
      );
    ...
    it("should handle fast and distinct vertical two finger drag", function () {
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 25.0, clientY: 30.0, magnitudeX: 0.0, magnitudeY: 65.0 },
        })
      );
    ...
    it("should handle fast and distinct diagonal two finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "twodrag", clientX: 125.0, clientY: 130.0, magnitudeX: 0.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 125.0, clientY: 130.0, magnitudeX: -55.0, magnitudeY: -50.0 },
        })
      );
    ...
    it("should handle slow horizontal two finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "twodrag", clientX: 55.0, clientY: 40.0, magnitudeX: 0.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 55.0, clientY: 40.0, magnitudeX: 40.0, magnitudeY: 0.0 },
        })
      );
    });
    ...
    it("should handle slow vertical two finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "twodrag", clientX: 40.0, clientY: 50.0, magnitudeX: 0.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 40.0, clientY: 50.0, magnitudeX: 0.0, magnitudeY: 40.0 },
        })
      );
    });
    ...
    it("should handle slow diagonal two finger drag", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "twodrag", clientX: 45.0, clientY: 50.0, magnitudeX: 0.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "twodrag", clientX: 45.0, clientY: 50.0, magnitudeX: 35.0, magnitudeY: 35.0 },
        })
      );
    });
  ...
  describe("Pinch", function () {
    it("should handle pinching distinctly and fast inwards", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "pinch", clientX: 65.0, clientY: 65.0, magnitudeX: 130.0, magnitudeY: 130.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "pinch", clientX: 65.0, clientY: 65.0, magnitudeX: 10.0, magnitudeY: 30.0 },
        })
      );
    ...
    it("should handle pinching fast and distinctly outwards", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "pinch", clientX: 105.0, clientY: 100.0, magnitudeX: 10.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "pinch", clientX: 105.0, clientY: 100.0, magnitudeX: 180.0, magnitudeY: 180.0 },
        })
      );
    ...
    it("should handle pinching inwards slowly", function () {
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "pinch", clientX: 65.0, clientY: 65.0, magnitudeX: 50.0, magnitudeY: 90.0 },
        })
      );
    });
    ...
    it("should handle pinching outwards slowly", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturestart",
          detail: { type: "pinch", clientX: 105.0, clientY: 130.0, magnitudeX: 10.0, magnitudeY: 0.0 },
        })
      );
      ...
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({
          type: "gesturemove",
          detail: { type: "pinch", clientX: 105.0, clientY: 130.0, magnitudeX: 100.0, magnitudeY: 0.0 },
        })
      );
    });
  ...
  describe("Ignoring", function () {
    it("should ignore extra touches during gesture", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "drag" } })
      );
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gesturemove", detail: { type: "drag" } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gesturemove", detail: { type: "drag", clientX: 100.0, clientY: 50.0 } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(
        sinon.match({ type: "gestureend", detail: { type: "drag", clientX: 100.0, clientY: 50.0 } })
      );
    });
    ...
    it("should ignore extra touches when waiting for gesture to end", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "twodrag" } })
      );
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gesturemove", detail: { type: "twodrag" } })
      );
      ...
      expect(gestures).to.have.been.calledOnceWith(sinon.match({ type: "gestureend", detail: { type: "twodrag" } }));
    ...
    it("should ignore extra touches after gesture", function () {
      ...
      expect(gestures).to.have.been.calledOnceWith(sinon.match({ type: "gesturemove", detail: { type: "drag" } }));

      gestures.resetHistory();

      touchEnd(1);

      expect(gestures).to.have.been.calledOnceWith(sinon.match({ type: "gestureend", detail: { type: "drag" } }));
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "onetap" } })
      );
      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gestureend", detail: { type: "onetap" } })
      );
    });
    ...
    it("should properly reset after a gesture", function () {
      ...
      expect(gestures.firstCall).to.have.been.calledWith(
        sinon.match({ type: "gesturestart", detail: { type: "onetap", clientX: 70.0, clientY: 80.0 } })
      );

      expect(gestures.secondCall).to.have.been.calledWith(
        sinon.match({ type: "gestureend", detail: { type: "onetap", clientX: 70.0, clientY: 80.0 } })
      );
    });
  });
});
