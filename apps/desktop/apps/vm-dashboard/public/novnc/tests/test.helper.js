...
describe("Helpers", function () {
  ...
  describe("getKey", function () {
    it("should prefer key", function () {
      expect(KeyboardUtil.getKey({ key: "a", charCode: "Š".charCodeAt(), keyCode: 0x42, which: 0x43 })).to.be.equal(
        "a"
      );
    });
    it("should map legacy values", function () {
  ...
  describe("getKeysym", function () {
    ...
    describe("Japanese IM keys on Windows", function () {
      ...
      const keys = { Zenkaku: 0xff2a, Hankaku: 0xff2a, Romaji: 0xff24, KanaMode: 0xff24 };
