...
function push32(arr, num) {
  "use strict";
  arr.push((num >> 24) & 0xff, (num >> 16) & 0xff, (num >> 8) & 0xff, num & 0xff);
}
...
describe("Remote Frame Buffer Protocol Client", function () {
  ...
  before(function () {
    ...
    Websock.prototype.inspect = function () {
      return "[object Websock]";
    };
  });
    ...
    describe("#clipboardPasteFrom", function () {
      describe("Clipboard update handling", function () {
        ...
        it("should send the given text in an clipboard update", function () {
          ...
          expect(RFB.messages.clientCutText).to.have.been.calledWith(client._sock, new Uint8Array([97, 98, 99]));
        });
        ...
        it("should mask unsupported characters", function () {
          ...
          expect(RFB.messages.clientCutText).to.have.been.calledOnce;
          expect(RFB.messages.clientCutText).to.have.been.calledWith(client._sock, new Uint8Array([97, 98, 99, 63]));
        });
        ...
        it("should mask characters, not UTF-16 code points", function () {
          ...
          expect(RFB.messages.clientCutText).to.have.been.calledOnce;
          expect(RFB.messages.clientCutText).to.have.been.calledWith(client._sock, new Uint8Array([63]));
        });
  ...
  describe("Clipping", function () {
    ...
    it("should update the viewport when the remote session resizes", function () {
      ...
      const incoming = [
        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0xff, 0xff, 0xff, 0xfe, 0xcc, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00,
      ];
  ...
  describe("Remote resize", function () {
    ...
    it("should request a resize when initially connecting", function () {
      ...
      const incoming = [
        ...
        0x00, // padding
        0x00,
        0x01, // number of rects = 1
        0x00,
        0x00, // reason = server initialized
        0x00,
        ...
        0xff,
        0xfe,
        0xcc, // enc = (-308) ExtendedDesktopSize
    ...
    it("should not request the same size twice", function () {
      ...
      const incoming = [
        0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x28, 0x00, 0x32, 0xff, 0xff, 0xfe, 0xcc, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00,
      ];
    ...
    it("should not try to override a server resize", function () {
      ...
      const incoming = [
        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x64, 0xff, 0xff, 0xfe, 0xcc, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
      ];
  ...
  describe("Protocol Initialization States", function () {
    ...
    describe("ProtocolVersion", function () {
      ...
      describe("Repeater", function () {
        ...
        it("should interpret version 000.000 as a repeater", function () {
          ...
          expect(new Uint8Array(sentData.buffer, 0, 9)).to.array.equal(
            new Uint8Array([73, 68, 58, 49, 50, 51, 52, 53, 0])
          );
    ...
    describe("Authentication", function () {
      ...
      describe("ARD Authentication (type 30) Handler", function () {
        ...
        it("should return properly encrypted credentials and public key", async function () {
          client._rfbCredentials = { username: "user", password: "password" };
          sendSecurity(30, client);
          ...
          let expectEncrypted = new Uint8Array([
            232, 234, 159, 162, 170, 180, 138, 104, 164, 49, 53, 96, 20, 36, 21, 15, 217, 219, 107, 173, 196, 60, 96,
            142, 215, 71, 13, 185, 185, 47, 5, 175, 151, 30, 194, 55, 173, 214, 141, 161, 36, 138, 146, 3, 178, 89, 43,
            248, 131, 134, 205, 174, 9, 150, 171, 74, 222, 201, 20, 2, 30, 168, 162, 123, 46, 86, 81, 221, 44, 211, 180,
            247, 221, 61, 95, 155, 157, 241, 76, 76, 49, 217, 234, 75, 147, 237, 199, 159, 93, 140, 191, 174, 52, 90,
            133, 58, 243, 81, 112, 182, 64, 62, 149, 7, 151, 28, 36, 161, 247, 247, 36, 96, 230, 95, 58, 207, 46, 183,
            100, 139, 143, 155, 224, 43, 219, 3, 71, 139,
          ]);
      ...
      describe("MSLogonII Authentication (type 113) Handler", function () {
        ...
        const expected = new Uint8Array([
          ,
        ]);
        before(() => {
        ...
        it("should send public value and encrypted credentials", function () {
          client._rfbCredentials = { username: "username", password: "password123456" };
      ...
      describe("XVP Authentication (type 22) Handler", function () {
        it("should fall through to standard VNC authentication upon completion", function () {
          client._rfbCredentials = { username: "user", target: "target", password: "password" };
        ...
        it("should fire the credentialsrequired event if some credentials are missing", function () {
          const spy = sinon.spy();
          client.addEventListener("credentialsrequired", spy);
          client._rfbCredentials = { username: "user", target: "target" };
          sendSecurity(22, client);
        ...
        it("should send user and target separately", function () {
          ...
          for (let i = 0; i < 10; i++) {
            expected[i + 3] = "usertarget".charCodeAt(i);
          }
    ...
    describe("SecurityResult", function () {
      ...
      it("should include reason when provided in securityfailure event", function () {
        const spy = sinon.spy();
        client.addEventListener("securityfailure", spy);
        const failureData = [0, 0, 0, 1, 0, 0, 0, 12, 115, 117, 99, 104, 32, 102, 97, 105, 108, 117, 114, 101];
        client._sock._websocket._receiveData(new Uint8Array(failureData));
        expect(spy).to.have.been.calledOnce;
  ...
  describe("Protocol Message Processing After Completing Initialization", function () {
      ...
      describe("Message Encoding Handlers", function () {
        ...
        describe("the ExtendedDesktopSize pseudo-encoding handler", function () {
          ...
          it("should handle a resize requested by this client", function () {
            ...
            sendFbuMsg(
              [{ x: reasonForChange, y: statusCode, width: 20, height: 50, encoding: -308 }],
              makeScreenData(1),
              client
            );
          ...
          it("should be able to recieve requests which contain data for multiple screens", function () {
            ...
            sendFbuMsg(
              [{ x: reasonForChange, y: statusCode, width: 60, height: 50, encoding: -308 }],
              makeScreenData(3),
              client
            );
        ...
        describe("the Cursor pseudo-encoding handler", function () {
          ...
          it("should handle a standard cursor", function () {
            const info = { x: 5, y: 7, width: 4, height: 4, encoding: -239 };
            let rect = [];
            let expected = [];
          ...
          it("should handle an empty cursor", function () {
            const info = { x: 0, y: 0, width: 0, height: 0, encoding: -239 };
            const rect = [];
          ...
          describe("dot for empty cursor", function () {
            ...
            it("should handle an empty cursor", function () {
              ...
              expect(client._cursor.change).to.have.been.calledOnce;
              expect(client._cursor.change).to.have.been.calledWith(dot.rgbaPixels, dot.hotx, dot.hoty, dot.w, dot.h);
            });
        ...
        describe("the VMware Cursor pseudo-encoding handler", function () {
          ...
          it("should handle the VMware cursor pseudo-encoding", function () {
            let data = [0x00, 0x00, 0xff, 0, 0x00, 0xff, 0x00, 0, 0x00, 0xff, 0x00, 0, 0x00, 0x00, 0xff, 0];
            let rect = [];
            push8(rect, 0);
            push8(rect, 0);
            ...
            sendFbuMsg([{ x: 0, y: 0, width: 2, height: 2, encoding: 0x574d5664 }], [rect], client);
          ...
          it("should handle insufficient cursor pixel data", function () {
            ...
            let w = 14;
            let h = 23;
            let data = [0x00, 0x00, 0xff, 0, 0x00, 0xff, 0x00, 0];
            let rect = [];
            ...
            sendFbuMsg([{ x: 0, y: 0, width: w, height: h, encoding: 0x574d5664 }], [rect], client);
          ...
          it("should update the cursor when type is classic", function () {
            ...
            let expectedRgba = [
              0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x33, 0x22, 0x11, 0xff, 0x00, 0x00, 0x00, 0xff,
            ];

            sendFbuMsg([{ x: hotx, y: hoty, width: w, height: h, encoding: 0x574d5664 }], [rect], client);

            expect(client._cursor.change).to.have.been.calledOnce;
            expect(client._cursor.change).to.have.been.calledWith(expectedRgba, hotx, hoty, w, h);
          });
          ...
          it("should update the cursor when type is alpha", function () {
            ...
            let expectedRgba = [
              0xee, 0x55, 0xff, 0x00, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0x22, 0x00, 0xff, 0x00, 0x22, 0x00,
              0xff, 0x00, 0x22, 0x00, 0x00, 0xff, 0xee,
            ];
          ...
          it("should not update cursor when incorrect cursor type given", function () {
            ...
            expect(client._cursor.change).to.not.have.been.called;
          });
        });
    ...
    describe("Normal Clipboard Handling Receive", function () {
      it("should fire the clipboard callback with the retrieved text on ServerCutText", function () {
        ...
        for (let i = 0; i < expectedStr.length; i++) {
          data.push(expectedStr.charCodeAt(i));
        }
        const spy = sinon.spy();
    ...
    describe("Extended clipboard Handling", function () {
      describe("Extended clipboard initialization", function () {
        ...
        it("should update capabilities when receiving a Caps message", function () {
          ...
          let fileSizes = [0x00, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00, 0x3c];
      ...
      describe("Extended Clipboard Handling Receive", function () {
        ...
        describe("Handle Provide", function () {
          it("should update clipboard with correct Unicode data from a Provide message", function () {
            ...
            let deflatedData = [
              120, 94, 99, 96, 96, 224, 114, 60, 188, 244, 217, 158, 69, 79, 215, 78, 87, 4, 0, 35, 207, 6, 66,
            ];
        ...
        describe("Handle Request", function () {
          ...
          it("should send a Provide message with supported formats when receiving a Request", function () {
            ...
            expect(RFB.messages.extendedClipboardProvide).to.have.been.calledWith(client._sock, expectedData, [
              "HejHej",
            ]);
          });
        });
  ...
  describe("Asynchronous Events", function () {
    ...
    describe("Mouse Events", function () {
      ...
      it("should handle left mouse button", function () {
        ...
        expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 10, 10, 0x1);
        pointerEvent.resetHistory();

        sendMouseButtonEvent(10, 10, false, 0);

        expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 10, 10, 0x0);
      });

      it("should handle middle mouse button", function () {
        sendMouseButtonEvent(10, 10, true, 1);

        expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 10, 10, 0x2);
        pointerEvent.resetHistory();
      ...
      it("should handle right mouse button", function () {
        ...
        expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 10, 10, 0x4);
        pointerEvent.resetHistory();
      ...
      it("should handle multiple mouse buttons", function () {
        ...
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 0x1);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0x5);
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 0x4);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0x0);
      });

      it("should handle mouse movement", function () {
        sendMouseMoveEvent(50, 70);
        expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 50, 70, 0x0);
      });
      ...
      it("should handle click and drag", function () {
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 0x1);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 50, 70, 0x1);
      ...
      describe("Event Aggregation", function () {
        ...
        it("should delay one move if two events are too close", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 18, 30, 0x0);
          pointerEvent.resetHistory();

          clock.tick(100);

          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 20, 50, 0x0);
        });
        ...
        it("should only send first and last move of many close events", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 21, 55, 0x0);
        });
        ...
        it("should send move events every 17 ms", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 1, 10, 0x0);
          pointerEvent.resetHistory();

          sendMouseMoveEvent(2, 20); // delayed
          clock.tick(10); // timeout send

          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 2, 20, 0x0);
          pointerEvent.resetHistory();
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 4, 40, 0x0);
          pointerEvent.resetHistory();
        ...
        it("should send waiting move events before a button press", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 13, 9, 0x0);
          pointerEvent.resetHistory();
          ...
          expect(pointerEvent).to.have.been.calledTwice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 20, 70, 0x0);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 20, 70, 0x1);
        });

        it("should send move events with enough time apart normally", function () {
          sendMouseMoveEvent(58, 60);

          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 58, 60, 0x0);
          pointerEvent.resetHistory();
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 25, 60, 0x0);
          pointerEvent.resetHistory();
        });
        ...
        it("should not send waiting move events if disconnected", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 88, 99, 0x0);
          pointerEvent.resetHistory();
    ...
    describe("Wheel Events", function () {
      ...
      it("should handle wheel up event", function () {
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 1 << 3);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0);
      });
      ...
      it("should handle wheel down event", function () {
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 1 << 4);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0);
      });
      ...
      it("should handle wheel left event", function () {
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 1 << 5);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0);
      });
      ...
      it("should handle wheel right event", function () {
        ...
        expect(pointerEvent).to.have.been.calledTwice;
        expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 10, 1 << 6);
        expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 10, 0);
      });
    ...
    describe("Gesture event handlers", function () {
      function gestureStart(gestureType, x, y, magnitudeX = 0, magnitudeY = 0) {
        let pos = elementToClient(x, y);
      ...
      function gestureMove(gestureType, x, y, magnitudeX = 0, magnitudeY = 0) {
        let pos = elementToClient(x, y);
        let detail = { type: gestureType, clientX: pos.x, clientY: pos.y };
      ...
      describe("Gesture onetap", function () {
        it("should handle onetap events", function () {
          ...
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 20, 40, 0x0);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 20, 40, bmask);
          expect(pointerEvent.thirdCall).to.have.been.calledWith(client._sock, 20, 40, 0x0);
        });
        ...
        it("should not keep same position for onetap events when too far apart", function () {
          ...
          expect(pointerEvent).to.have.been.calledThrice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 80, 95, 0x0);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 80, 95, bmask);
          expect(pointerEvent.thirdCall).to.have.been.calledWith(client._sock, 80, 95, 0x0);
        });
        ...
        it("should not keep same position for onetap events when enough time inbetween", function () {
          ...
          expect(pointerEvent).to.have.been.calledThrice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 10, 20, 0x0);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 10, 20, bmask);
          expect(pointerEvent.thirdCall).to.have.been.calledWith(client._sock, 10, 20, 0x0);
          ...
          expect(pointerEvent).to.have.been.calledThrice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 15, 20, 0x0);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 15, 20, bmask);
          expect(pointerEvent.thirdCall).to.have.been.calledWith(client._sock, 15, 20, 0x0);
      ...
      describe("Gesture drag", function () {
        it("should handle gesture drag events", function () {
          ...
          expect(pointerEvent).to.have.been.calledWith(client._sock, 30, 50, bmask);
          ...
          expect(pointerEvent).to.have.been.calledTwice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 30, 50, bmask);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 30, 50, 0x0);
        });
      });
      ...
      describe("Gesture long press", function () {
        it("should handle long press events", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 40, 60, bmask);
          ...
          expect(pointerEvent).to.have.been.calledTwice;
          expect(pointerEvent.firstCall).to.have.been.calledWith(client._sock, 40, 60, bmask);
          expect(pointerEvent.secondCall).to.have.been.calledWith(client._sock, 40, 60, 0x0);
        });
      });
      ...
      describe("Gesture twodrag", function () {
        it("should handle gesture twodrag up events", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 20, 40, 0x0);
        ...
        it("should handle gesture twodrag diag events", function () {
          ...
          expect(pointerEvent.getCall(0)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
          expect(pointerEvent.getCall(1)).to.have.been.calledWith(client._sock, 20, 40, scrlUp);
          expect(pointerEvent.getCall(2)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
          expect(pointerEvent.getCall(3)).to.have.been.calledWith(client._sock, 20, 40, scrlRight);
          expect(pointerEvent.getCall(4)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
        });
        ...
        it("should handle large gesture twodrag events", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 30, 50, 0x0);
          ...
          expect(pointerEvent.getCall(0)).to.have.been.calledWith(client._sock, 30, 50, 0x0);
          expect(pointerEvent.getCall(1)).to.have.been.calledWith(client._sock, 30, 50, bmask);
          expect(pointerEvent.getCall(2)).to.have.been.calledWith(client._sock, 30, 50, 0x0);
          expect(pointerEvent.getCall(3)).to.have.been.calledWith(client._sock, 30, 50, bmask);
          expect(pointerEvent.getCall(4)).to.have.been.calledWith(client._sock, 30, 50, 0x0);
          expect(pointerEvent.getCall(5)).to.have.been.calledWith(client._sock, 30, 50, bmask);
          expect(pointerEvent.getCall(6)).to.have.been.calledWith(client._sock, 30, 50, 0x0);
        });
      });
      ...
      describe("Gesture pinch", function () {
        it("should handle gesture pinch in events", function () {
          ...
          expect(keyEvent.firstCall).to.have.been.calledWith(client._sock, keysym, 1);
          expect(keyEvent.secondCall).to.have.been.calledWith(client._sock, keysym, 0);
        ...
        it("should handle gesture pinch out events", function () {
          ...
          expect(pointerEvent).to.have.been.calledOnceWith(client._sock, 10, 20, 0x0);
          expect(keyEvent).to.not.have.been.called;
        ...
        it("should handle large gesture pinch", function () {
          ...
          expect(pointerEvent).to.have.been.callCount(5);
          expect(pointerEvent.getCall(0)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
          expect(pointerEvent.getCall(1)).to.have.been.calledWith(client._sock, 20, 40, bmask);
          expect(pointerEvent.getCall(2)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
          expect(pointerEvent.getCall(3)).to.have.been.calledWith(client._sock, 20, 40, bmask);
          expect(pointerEvent.getCall(4)).to.have.been.calledWith(client._sock, 20, 40, 0x0);
        ...
        it("should handle multiple small gesture pinch out events", function () {
          ...
          expect(pointerEvent).to.have.been.calledWith(client._sock, 20, 40, 0x0);
        ...
        it("should send correct key control code", function () {
          ...
          expect(qemuKeyEvent.firstCall).to.have.been.calledWith(client._sock, keysym, true, code);
          expect(qemuKeyEvent.secondCall).to.have.been.calledWith(client._sock, keysym, false, code);
  ...
  describe("Quality level setting", function () {
    ...
    it("should send clientEncodings with new quality value", function () {
      ...
      expect(RFB.messages.clientEncodings).to.have.been.calledOnce;
      expect(RFB.messages.clientEncodings.getCall(0).args[1]).to.include(
        encodings.pseudoEncodingQualityLevel0 + newQuality
      );
    });
  ...
  describe("Compression level setting", function () {
    ...
    it("should send clientEncodings with new compression value", function () {
      ...
      expect(RFB.messages.clientEncodings).to.have.been.calledOnce;
      expect(RFB.messages.clientEncodings.getCall(0).args[1]).to.include(
        encodings.pseudoEncodingCompressLevel0 + newCompression
      );
    });
...
describe("RFB messages", function () {
  ...
  describe("Extended Clipboard Handling Send", function () {
    ...
    it("should call clientCutText with correct Caps data", function () {
      ...
      let expectedData = new Uint8Array([0x1f, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x10, 0x19]);
      let actions = [
        1 << 24, // Caps
        1 << 25, // Request
        1 << 26, // Peek
