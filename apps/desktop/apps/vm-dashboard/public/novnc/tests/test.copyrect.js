...
describe("CopyRect Decoder", function () {
  ...
  it("should handle the CopyRect encoding", function () {
    ...
    testDecodeRect(decoder, 0, 2, 2, 2, [0x00, 0x02, 0x00, 0x00], display, 24);
    testDecodeRect(decoder, 2, 2, 2, 2, [0x00, 0x00, 0x00, 0x00], display, 24);

    let targetData = new Uint8Array([
      0x00, 0x00, 0xff, 255, 0x00, 0x00, 0xff, 255, 0x00, 0xff, 0x00, 255, 0x00, 0xff, 0x00, 255, 0x00, 0x00, 0xff, 255,
      0x00, 0x00, 0xff, 255, 0x00, 0xff, 0x00, 255, 0x00, 0xff, 0x00, 255, 0x00, 0xff, 0x00, 255, 0x00, 0xff, 0x00, 255,
      0x00, 0x00, 0xff, 255, 0x00, 0x00, 0xff, 255, 0x00, 0xff, 0x00, 255, 0x00, 0xff, 0x00, 255, 0x00, 0x00, 0xff, 255,
      0x00, 0x00, 0xff, 255,
    ]);
