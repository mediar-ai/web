...
export async function GET() {
  ...
  const { data: machines, error } = await supabase
    ...
    .select('id, name, status, health_status, region, machine_type, provisioning_step, created_at, provisioned_at, owner_user_id, owner_org_id, terraform_key, mcp_endpoint, tags')
