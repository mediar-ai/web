...
export function OnboardingSection({ forceShow = false, onDismiss }: OnboardingSectionProps) {
  ...
  }, [currentStep, setCurrentStep, completeOnboarding, onDismiss]);
  ...
  // Don't show if dismissed or onboarding not needed (unless forceShow)
  if (!forceShow && (isDismissed || !shouldShowOnboarding)) {
    return null;
  }
